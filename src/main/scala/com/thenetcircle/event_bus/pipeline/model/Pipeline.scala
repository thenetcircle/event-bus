...
trait Pipeline {
  ...
  val _type: PipelineType
  val settings: PipelineSettings

  def createInlet(inletSettings: PipelineInletSettings): PipelineInlet

  def createOutlet(outletSettings: PipelineOutletSettings): PipelineOutlet
