...
class HttpTaskCBuilderTest extends AkkaStreamTest {

  behavior of "HttpTaskCBuilder"

  val builder = new HttpTaskCBuilder

  it should "build correct HttpTaskC with the default config" in {
